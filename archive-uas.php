            ...
            <div class="col-lg-12">
                <div class="about-tab-btn about-item-area  mt-40">
                    <div class="archive-btn for-search">
						<?php
					$post_type = 'uas'; // Replace 'your_post_type' with the desired post type
					$post_counts = wp_count_posts($post_type);
					$total_count = $post_counts->publish;
					?>
					 <span class="searchresult-topic"><?php echo single_term_title() . 'All Universities: (Total ' . $total_count . ' Universities)'; ?></span>
                    </div>
