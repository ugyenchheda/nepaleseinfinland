...
function nepaleseinfinland_setup() {
	/*
		...
		* If you're building a theme based on NepaleseinFinland, use a find and replace
		* to change 'nepaleseinfinland' to the name of your theme in all the template files.
		*/
